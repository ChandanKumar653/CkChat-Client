...
e.preventDefault();
  ...
  return (
    <div className="h-screen overflow-y-auto w-full md:w-[20rem] bg-[#0e0e0f]">
      <div>
        <TextField
      ...
      <div
        className="text-white p-3 bg-[grey] cursor-pointer"
        onClick={()=>{props.userClicked(true)}}
      ...
      >
        <Avatar
          ...
          style={{ width: "50px", height: "50px", borderRadius: "50%",marginLeft:5 }}
        />
        <span className="pl-4 font-semibold">Jhon Doe</span>
      </div>
    </div>
  );
}
