...
export default function Header({userClicked}) {
        ...
        {userClicked ? (
          <>
            <div className="flex items-center justify-center text-white ml-3 md:ml-[15rem]">
              ...
              />
              <Typography color={"white"} className="pl-2 font-semibold">
                Jhon Doe
              </Typography>
            </div>

            <div className="flex items-center justify-end text-white font-bold ml-auto md:mr-14 space-x-4 md:space-x-14">
              <CallIcon className="cursor-pointer text-4xl md:text-9xl" />
              <VideoCallIcon className="cursor-pointer text-4xl md:text-9xl" />
