...
export default function Header({userClicked}) {
  ...
  return (
    <div>
      <nav className="flex h-16 md:h-22 w-full bg-[black]">
        <div className="flex items-center ml-3 md:ml-10" onClick={()=>{navigate("/")}}>
        ...
        {userClicked ? (
          <>
            <div className="flex items-center justify-center text-white ml-3">
              <Avatar
                alt="Remy Sharp"
